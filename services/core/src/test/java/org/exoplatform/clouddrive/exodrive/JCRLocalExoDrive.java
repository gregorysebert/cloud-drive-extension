      ...
      try {
        ...
        for (FileStore f : files) {
          ...
          initFile(localNode,
                   ...
                   f.getAuthor(),
                   f.getCreateDate(),
<<<<<<< HEAD:services/core/src/main/java/org/exoplatform/clouddrive/exodrive/JCRLocalExoDrive.java
...
=======
          ...
          changed.add(new JCRLocalCloudFile(localNode.getPath(),
                                            ...
                                            f.getType(),
                                            null,
>>>>>>> FETCH_HEAD:services/core/src/test/java/org/exoplatform/clouddrive/exodrive/JCRLocalExoDrive.java
                                            f.getLink(),
                                            f.getLink(),
                                            f.getLink(),
                                            f.getAuthor(),
